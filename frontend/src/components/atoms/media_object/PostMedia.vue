...
.panel-block
  ...
  .a-post-media-right
    .a-post-media-right-title
      h1
        b {{ title }}
    .a-post-media-right-organization(v-show='organization')
      span.icon.is-small
        i.fa.fa-briefcase.org
      small {{ organization }}
    .a-post-media-right-summary
      p
        | {{ summary }}
</template>
...
.a-post-media-right
  ...
  &-title
    ...
    h1
      ...
      border-left: $custome_gray solid 10px
