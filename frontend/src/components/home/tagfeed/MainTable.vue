...
.hero
  .panel-block
    .post-header
      ...
      .title.is-6 タグ・フィード
  post(tag='Ruby', when='15 minutes ago',
  ...
  post(tag='Ruby on Rails', when='1 hours ago',
  ...
  post(tag='Docker', when='1 week ago',
  ...
  post(tag='JavaScript', when='1 months ago',
  ...
  post(tag='WEB', when='1 months ago',
