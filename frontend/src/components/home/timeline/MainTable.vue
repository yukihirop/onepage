...
.hero
  .panel-block
    .chat-header
      ...
      .title.is-6 タイムライン
  chat(:profile-image-src='require("../../../assets/home/user/yusabana.png")',
       who='Yuma Inaura', what='コメント', when='1 hour ago',
       comment='とっても聞いてみたいと思いました。',
       refTitle='コードレビューで気をつけていること',
       refComments=2)
  post(:profile-image-src='require("../../../assets/home/user/aimerald.png")',
       who='aimerald', when='3 hours ago',
  ...
  like(:profile-image-src='require("../../../assets/home/user/YumaInaura.png")',
       who='aimerald', when='1 day ago',
  ...
  chat(:profile-image-src='require("../../../assets/home/user/yaotti.png")',
       who='skuroki', when='2 days ago',
       comment='資料の構成が非常に参考になりました。',
       refTitle='新人プログラマとペアプロしてわかったこと',
       refComments=72)
  post(:profile-image-src='require("../../../assets/home/user/YumaInaura.png")',
