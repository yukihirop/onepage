...
.hero
  ...
  post(who='yukihirop', when='3 hours ago', likes=278,
  ...
  post(who='aimerald', when='3 hours ago', likes=278,
  ...
  post(who='Yuma Inaura', when='1 day ago', likes=278,
  ...
  post(who='skuroki', when='2 days ago', likes=278,
  ...
  post(who='yuemori', when='1 week ago', likes=278,
  ...
  post(who='Koji Miyake', when='2 months ago', likes=278,
